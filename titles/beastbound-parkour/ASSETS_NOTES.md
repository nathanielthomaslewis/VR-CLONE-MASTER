# ASSETS_NOTES — Beastbound

Original art only. Stylised low-poly PBR, Quest LODs.

## Image prompts (concept / mood)

1. Key art: Beastbound — Beast-bonded parkour — swing and vault through a neon canyon using arm locomotion; collect runes before the bond fades.…
...
- Filename prefix: `beastbound_parkour_`

**No shared vehicle assets.** Optional shared comfort vignette shaders only.
